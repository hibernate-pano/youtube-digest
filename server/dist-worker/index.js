(() => {
  ...
  var require_serverless = __commonJS({
    "node_modules/@neondatabase/serverless/index.js"(exports, module) {
      ...
      var re = /* @__PURE__ */ __name((r, e) => {
        for (var t in e)
          Te(r, t, { get: e[t], enumerable: true });
      }, "re");
      var Pn = /* @__PURE__ */ __name((r, e, t, n) => {
        if (e && typeof e == "object" || typeof e == "function") for (let i of oo(e)) !uo.call(r, i) && i !== t && Te(r, i, { get: /* @__PURE__ */ __name(() => e[i], "get"), enumerable: !(n = so(e, i)) || n.enumerable });
        return r;
      }, "Pn");
      var Ie = /* @__PURE__ */ __name((r, e, t) => (t = r != null ? io(ao(r)) : {}, Pn(e || !r || !r.__esModule ? Te(t, "default", {
        value: r,
        enumerable: true
      }) : t, r)), "Ie");
      var O = /* @__PURE__ */ __name((r) => Pn(Te({}, "__esModule", { value: true }), r), "O");
      ...
      var He = {};
      re(He, { default: /* @__PURE__ */ __name(() => zo, "default") });
      var zo;
      var Ge = z(() => {
        "use strict";
        p();
      ...
      var Ht = {};
      re(Ht, { createHash: /* @__PURE__ */ __name(() => Zo, "createHash"), createHmac: /* @__PURE__ */ __name(() => Jo, "createHmac"), randomBytes: /* @__PURE__ */ __name(() => Yo, "randomBytes") });
      function Yo(r) {
      ...
      var sr = {};
      re(sr, { join: /* @__PURE__ */ __name(() => cu, "join") });
      function cu(...r) {
        return r.join("/");
      }
      __name(cu, "cu");
      ...
      var ar = {};
      re(ar, { stat: /* @__PURE__ */ __name(() => hu, "stat") });
      function hu(r, e) {
      ...
      var cr = {};
      re(cr, { default: /* @__PURE__ */ __name(() => lu, "default") });
      var lu;
      var hr = z(() => {
        "use strict";
        p();
      ...
      var Gi = {};
      re(Gi, { StringDecoder: /* @__PURE__ */ __name(() => lr, "StringDecoder") });
      var fr;
      var lr;
      var $i = z(() => {
        "use strict";
...
`);
      ...
      var ns = {};
      re(ns, { default: /* @__PURE__ */ __name(() => Bu, "default") });
      var Bu;
      var is = z(() => {
        "use strict";
        p();
      ...
      var ss = {};
      re(ss, { parse: /* @__PURE__ */ __name(() => mr, "parse") });
      ...
      var Ss = {};
      re(Ss, { Socket: /* @__PURE__ */ __name(() => Se, "Socket"), isIP: /* @__PURE__ */ __name(() => ku, "isIP") });
      function ku(r) {
        return 0;
      }
      __name(ku, "ku");
      ...
      var Is = {};
      re(Is, { connect: /* @__PURE__ */ __name(() => pc, "connect") });
      ...
      var qs = {};
      re(qs, { default: /* @__PURE__ */ __name(() => Ic, "default") });
      var Ic;
      var Qs = z(() => {
        "use strict";
        p();
      ...
      var Vc = {};
      re(Vc, {
        Client: /* @__PURE__ */ __name(() => Bt, "Client"),
        ClientBase: /* @__PURE__ */ __name(() => oe.ClientBase, "ClientBase"),
        Connection: /* @__PURE__ */ __name(() => oe.Connection, "Connection"),
        DatabaseError: /* @__PURE__ */ __name(() => oe.DatabaseError, "DatabaseError"),
        NeonDbError: /* @__PURE__ */ __name(() => he, "NeonDbError"),
        Pool: /* @__PURE__ */ __name(() => Cn, "Pool"),
        Query: /* @__PURE__ */ __name(() => oe.Query, "Query"),
        defaults: /* @__PURE__ */ __name(() => oe.defaults, "defaults"),
        neon: /* @__PURE__ */ __name(() => An, "neon"),
        neonConfig: /* @__PURE__ */ __name(() => Se, "neonConfig"),
        types: /* @__PURE__ */ __name(() => oe.types, "types")
      });
      module.exports = O(Vc);
      p();
      var Lt = Ie(It());
  ...
  var require_db = __commonJS({
    "src/db.js"(exports, module) {
      ...
      __name(rowToVocabulary, "rowToVocabulary");
      var MemoryStore = class {
        ...
        async listNotes(userId) {
          return [...this.notes.values()].filter((row) => row.userId === userId).sort((a, b) => a.updatedAt < b.updatedAt ? 1 : -1);
        }
        ...
        async listVocabulary(userId) {
          return [...this.vocabulary.values()].filter((row) => row.userId === userId).sort((a, b) => a.updatedAt < b.updatedAt ? 1 : -1);
        }
        async upsertVocabulary(userId, vocab) {
          const existing = [...this.vocabulary.values()].find(
            (row2) => row2.userId === userId && row2.term === vocab.term && row2.sentence === vocab.sentence
          );
          const now = this.clock().toISOString();
          if (existing) {
        ...
        async listDueReviews(userId, limit = DEFAULT_REVIEW_LIMIT) {
          ...
          }).sort((a, b) => a.dueAt < b.dueAt ? -1 : 1).slice(0, limit).map((review) => ({
            review: {
              dueAt: review.dueAt,
        ...
        async getSyncDelta(userId, sinceIso) {
          const since = sinceIso ? new Date(sinceIso) : /* @__PURE__ */ new Date(0);
          const notes = [...this.notes.values()].filter((row) => row.userId === userId && new Date(row.updatedAt) > since).map(rowToNote);
          const vocabulary = [...this.vocabulary.values()].filter((row) => row.userId === userId && new Date(row.updatedAt) > since).map(rowToVocabulary);
      ...
      function applyGrade(review, grade, now) {
        ...
        if (grade < 2) {
          ...
          next.intervalDays = 0;
          next.dueAt = new Date(now.getTime() + 10 * 60 * 1e3).toISOString();
          return next;
        }
        next.reps += 1;
        if (next.reps === 1) {
        ...
        next.dueAt = new Date(now.getTime() + next.intervalDays * 864e5).toISOString();
        return next;
      }
      __name(applyGrade, "applyGrade");
      var NeonStore = class {
        static {
          __name(this, "NeonStore");
        }
        constructor(connectionString) {
          const driver = require_serverless();
    ...
    `;
          ...
          const scheduled = applyGrade(base, grade, /* @__PURE__ */ new Date());
          const rows = await this.sql`
    ...
    `;
        ...
        async getSyncDelta(userId, sinceIso) {
          const since = sinceIso || (/* @__PURE__ */ new Date(0)).toISOString();
  ...
  var require_validate = __commonJS({
    "src/validate.js"(exports, module) {
      ...
      var MAX_QUOTE_LENGTH = 3e3;
      var MAX_VIDEO_TITLE_LENGTH = 300;
      var MAX_CHANNEL_LENGTH = 200;
      var MAX_TERM_LENGTH = 200;
      var MAX_TRANSLATION_LENGTH = 500;
      var MAX_SENTENCE_LENGTH = 4e3;
      ...
      function cleanTimestampSeconds(value) {
        ...
        return Math.min(Math.floor(number), 86400 * 30);
      }
      __name(cleanTimestampSeconds, "cleanTimestampSeconds");
      ...
      var VOCABULARY_STATUSES = /* @__PURE__ */ new Set(["learning", "reviewing", "mastered"]);
      ...
      __name(parseVocabulary, "parseVocabulary");
      var REVIEW_GRADES = /* @__PURE__ */ new Set([0, 1, 2, 3, 4, 5]);
      function parseReviewGrade(value) {
        const grade = Number(value);
        return Number.isInteger(grade) && REVIEW_GRADES.has(grade) ? grade : null;
      }
      __name(parseReviewGrade, "parseReviewGrade");
      module.exports = {
        cleanString,
        cleanVideoId,
        parseNote,
  ...
  var require_notes = __commonJS({
    "src/routes/notes.js"(exports, module) {
      var { json, HttpError } = require_middleware();
      var { parseNote } = require_validate();
  ...
  // src/routes/vocabulary.js
  var require_vocabulary = __commonJS({
    "src/routes/vocabulary.js"(exports, module) {
      var { json, HttpError } = require_middleware();
      var { parseVocabulary, VOCABULARY_STATUSES } = require_validate();
      async function listVocabulary(ctx) {
        const rows = await ctx.store.listVocabulary(ctx.user.id);
        return json({ vocabulary: rows });
      }
      __name(listVocabulary, "listVocabulary");
      ...
      __name(upsertVocabulary, "upsertVocabulary");
      ...
      __name(updateVocabularyStatus, "updateVocabularyStatus");
      ...
      __name(deleteVocabulary, "deleteVocabulary");
  ...
  var require_reviews = __commonJS({
    "src/routes/reviews.js"(exports, module) {
      var { json, HttpError } = require_middleware();
      var { parseReviewGrade } = require_validate();
      ...
      __name(listDueReviews, "listDueReviews");
  ...
  var require_me = __commonJS({
    "src/routes/me.js"(exports, module) {
      var { json } = require_middleware();
      ...
      async function syncDelta(ctx) {
        ...
        const delta = await ctx.store.getSyncDelta(ctx.user.id, since || void 0);
        return json(delta);
      }
      __name(syncDelta, "syncDelta");
  ...
  var require_index = __commonJS({
    "src/index.js"(exports, module) {
      var { signToken } = require_jwt();
      var { HttpError, requireUser, json } = require_middleware();
      var { createStore } = require_db();
      var auth = require_auth();
      var notes = require_notes();
      var vocabulary = require_vocabulary();
      var reviews = require_reviews();
      var meRoutes = require_me();
      var SESSION_TTL_SECONDS = 30 * 24 * 60 * 60;
      var STATE_COOKIE = "ytd_oauth_state";
